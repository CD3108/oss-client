...
//(function (H) {
	...
	var noop = function () {},
		...
		fireEvent = Highcharts.HighchartsAdapter.fireEvent,
		inArray = Highcharts.HighchartsAdapter.inArray,
		dupes = [],
		ddSeriesId = 1;
	...
	each(['fill', 'stroke'], function (prop) {
		Highcharts.HighchartsAdapter.addAnimSetter(prop, function (fx) {

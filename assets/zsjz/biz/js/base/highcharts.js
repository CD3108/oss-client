...
define(["jquery"],function(JQ){
	...
	(function ($) {
		...
		Highcharts.HighchartsAdapter = Highcharts.HighchartsAdapter || ($ && {
	...
	var globalAdapter = Highcharts.HighchartsAdapter,
	...
	(function (H) {
		var Chart = H.Chart,
			each = H.each,
			addEvent = H.HighchartsAdapter.addEvent;
